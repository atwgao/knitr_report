...
# our_info[, 3:6] %>%
#   mutate(
#     table1 = cell_spec(table1, "latex", color = ifelse(table1 == "No*", "red", "blue")),
#     table2 = cell_spec(table2, "latex", color = ifelse(table2 == "No*", "red", "blue")),
#     table3 = cell_spec(table3, "latex", color = ifelse(table3 == "No*", "red", "blue")),
#     table4 = cell_spec(table4, "latex", color = ifelse(table4 == "No*", "red", "blue")),
# 
#   ) %>%
