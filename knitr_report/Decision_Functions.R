...
funny<-function(Freq){
  ...
  if(dat[1]=="NaN"&dat[2]!="NaN"&dat[3]!="NaN"){
    plot(dat[2:3],xlab="Tutorial Attendance",ylab="Final Marks (%)",main=paste("Means of students' final marks against\ntutorial attendence for the module",Module),cex.lab=1.5,font.lab=2,ylim=c(10,110),axes = FALSE,type="l",lwd=16,col="lightgreen")
    ...
    plot(c(dat[1],dat[3]),xlab="Tutorial Attendance",ylab="Final Marks (%)",main=paste("Means of students' final marks against\ntutorial attendence for the module",Module),cex.lab=1.5,font.lab=2,ylim=c(10,110),axes = FALSE,type="l",lwd=16,col="lightgreen")
    axis(2);axis(side=1,at=c(1,2),labels=c("Students who\nnever attended\ntutorials","Students who\nattended 5\n or more tutorials"))
    ...
    plot(dat[1:2],xlab="Tutorial Attendance",ylab="Final Marks (%)",main=paste("Means of students' final marks against\ntutorial attendence for the module",Module),cex.lab=1.5,font.lab=2,ylim=c(10,110),axes = FALSE,type="l",lwd=16,col="lightgreen")
    axis(2);axis(side=1,at=c(1,2),labels=c("Students who\nnever attended\ntutorials","Students who\nattended 1-4\ntutorials"))
    ...
    plot(dat,xlab="Tutorial Attendance",ylab="Final Marks (%)",main=paste("Means of students' final marks against\ntutorial attendence for the module",Module),cex.lab=1.5,font.lab=2,ylim=c(10,110),axes = FALSE,type="l",lwd=16,col="lightgreen")
    ...
    type<-c("Students who\nnever attended\ntutorials","Students who\nattended 1-4\ntutorials","Students who\nattended 5\n or more tutorials")
    plot(dat[dat!="NaN"],xlab="Tutorial Attendance",ylab="Final Marks (%)",main=paste("Means of students' final marks against\ntutorial attendence for the module",Module),cex.lab=1.5,font.lab=2,ylim=c(10,110),axes = FALSE,type="l",lwd=16,col="lightgreen")
